...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--rollouts1", type=int, default=0, help=(
        "Only relevant if player1type is mcts; number of rollouts it should"
        " run. Default=0."))

    p.add_argument("--rollouts2", type=int, default=0, help=(
        "Only relevant if player2type is mcts; number of rollouts it should"
        " run. Default=0."))
...
def main() -> None:
    ...
    if args.player1type == 'human':
        ...
        players[PLAYER_1] = MctsPlayer(args.rollouts1, args.ucb1)
    else:
    ...
    if args.player2type == 'human':
        ...
        players[PLAYER_2] = MctsPlayer(args.rollouts2, args.ucb2)
    else:
